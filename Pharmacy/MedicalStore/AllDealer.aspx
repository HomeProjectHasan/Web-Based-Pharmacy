<%@ Page Title="" Language="C#" MasterPageFile="~/MedicalStore.Master" AutoEventWireup="true" CodeBehind="AllDealer.aspx.cs" Inherits="MedicalStore.output6" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <script type="text/javascript">
         ...
         function BindGridView() {
             $.ajax({
                 type: "POST",
                 url: "AllDealer.aspx/ShowAllDealers",
                 data: "{}",
