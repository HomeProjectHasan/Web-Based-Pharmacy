...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="signup" style="padding-bottom: 60px; padding-top: 75px;">
            ...
            <div class="div" style="padding-left: 7px; padding-right: 7px; margin-left: 40px; color: black">
                ...
                <asp:Button runat="server" ID="Button3" Text="Exist User" Height="30px" Width="100px" Font-Size="Larger" Font-Bold="true" Style="border: 2px solid white; padding-left: 10px; padding-right: 10px; border-radius: 8px; margin-left: 52px;" PostBackUrl="~/Login.aspx" />
                <br />
                &nbsp;&nbsp;&nbsp;
            <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
